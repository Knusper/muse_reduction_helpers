...
- script: ~gen_sofs_for_scipost2.sh~, usage ~gen_sofs_for_scipost2.sh ./object_dir/~
...
- script ~esorex_scipost2.sh~
  - uses `--autcalib=deepfield` as default

** Combine cubes with mpdaf

- python script ~mpdaf_scipost2_combine.py~, usage ~mpdaf_scipost2_combine.py -d J1044+0353_reduced~

* Third pass - update the sky mask
...
- example usage: ~gen_cont_image.py -i ./DATACUBE_scipost_2_mpdaf_cmbd.fits -l 1150 1400 1830 1990~
